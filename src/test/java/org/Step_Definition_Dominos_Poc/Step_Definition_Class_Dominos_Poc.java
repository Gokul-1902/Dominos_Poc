...
public class Step_Definition_Class_Dominos_Poc extends Base_Class_Dominos_Poc{
	...
	public void the_user_launch_dominos_url() {
		geturl(driver, "https://www.dominos.co.in/");
    }
	...
	public void user_have_to_click_the_peppy_paneer_pizza_two_qty() {	
        ...
        WebElement Margherita = driver.findElement(By.xpath("//div[@data-label='Veg Pizza']/div[6]/div/div/div[1]/div/div[3]/span"));
		WebElement PeppyPaneer
		= driver.findElement(By.xpath("//div[@data-label='Veg Pizza']/div[8]/div/div/div[1]/div/div[3]/span"));

		String price = Margherita.getText();
		String price1 = PeppyPaneer.getText();

		double pizza = Double.parseDouble(price);
		double pizaa1 = Double.parseDouble(price1);

		Double d = pizza*1+pizaa1*2;
		WebElement Subtotal = driver.findElement(By.xpath("//div[@class='menu-right']/div/div/div[2]/div[1]/span[2]"));

		String price2 = Subtotal.getText();
	...
	public void user_have_to_click_the_pepsi_475ml_twelve_qty() throws InterruptedException {
		...
		WebElement PeppyPaneer
			...
			double pizza = Double.parseDouble(price);
			double pizaa1 = Double.parseDouble(price1);
		WebElement pepsi = driver.findElement(By.xpath("/html/body//div[@data-label='Beverages']/div/div/div[1]/div/div/div[3]/span"));
			String price2= pepsi.getText();

			Double d = pizza*1+pizaa1*2+pepsi1*12;

            double pepsi1 = Double.parseDouble(price2);
		WebElement Subtotal1 = driver.findElement(By.xpath("//div[@class='menu-right']/div/div/div[2]/div[1]/span[2]"));

			String price13 = Subtotal1.getText();
	...
	public void the_user_view_the_place_order_page() throws InterruptedException {		
         ...
         WebElement Subtotal = driver.findElement(By.xpath("//div[@class='menu-right']/div/div/div[2]/div[1]/span[2]"));
                ...
                Thread.sleep(5000);
		WebElement subtotal1 = driver.findElement(By.xpath("//div[@class='right']/div/div[6]/div/div/div[1]/span[2]/span"));
		
		String price1 = subtotal1.getText();
